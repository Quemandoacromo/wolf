...
Run `iperf3 -c <your wolf server> -t 690 -u -R -b 100M` on your client laptop.
  ...
  - `-b 100M` limits the bandwidth used to 100 megabits per second. Alter to match the expected maximum bandwidth you are going to have going over your network.
